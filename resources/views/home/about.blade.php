...
@section('content')
    <div class="column is-12 react-streams" style="padding: 0">
        <div class="columns is-mobile is-multiline is-centered streams">
                ...
                <div class="columns is-multiline">
                    ...
                    <div class="column is-12 is-relative">
                        <p style="  text-align: justify;">
                            StreamBuddy came to my mind in year 2018 when I was playing Fortnite regularly and saw how
                            many
                            great
                            ...
                            streams. Never became a great streamer, but was playing high level Cs:Go, League of Legends
                            and
            ...
            <div class="column is-11-tablet is-8-desktop is-11-mobile about__box">
                <div class="columns is-multiline">
                    ...
                    <div class="column is-12 is-relative">
                        <p style="text-align: justify;">
                            StreamBuddy is a cross-platform stream browser featuring top streams from platforms like
                            Twitch
                            ...
                            performance of the website is also designed to be as high as possible. Application is still
                            in
                ...
                <div class="columns is-multiline">
                    ...
                    <div class="column is-12 is-relative">
                        <p style="text-align: justify;">
                            ...
                            Streams are updated every 5 minutes. All the streams we are fetching are the most popular
                            from
                ...
                <div class="columns is-multiline">
                    ...
                    <div class="column is-12 is-relative">
                        <p style="text-align: justify;">
                            ...
                            for people to check what is being streamed on which website right now. We want people to
                            come
